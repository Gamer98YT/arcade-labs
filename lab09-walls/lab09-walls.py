...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        # Create the cameras for Arcade 3.0
        # One for the GUI, one for the sprites.
    ...
    def on_update(self, delta_time):
        ...
        # Scroll the window to the player in Arcade 3.0
        # Simplemente igualamos la posición de la cámara al centro del jugador
        self.camera_for_sprites.position = (self.player_sprite.center_x, self.player_sprite.center_y)
