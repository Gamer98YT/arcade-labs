...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.coche_rojo_x = 400
        self.coche_rojo_y = 95
    ...
    def on_draw(self):
        ...
        dibujar_coche_deportivo(self.coche_rojo_x, self.coche_rojo_y)

    def on_update (self, delta_time):
        if self.joystick:
            x_axis = self.joystick.x
            y_axis = self.joystick.y
            self.coche_rojo_x += x_axis * 5
            self.coche_rojo_y -= y_axis * 5
